      ...
      {loading || error ? (
        ...
        <div className="">
          <Swiper
            ...
            grabCursor={true}
            centeredSlides={true}
            className=" relative max-w-full w-[100%] h-96 sm:h-80 rounded-lg cursor-grab mt-[7rem]"
          >
            {validData.map(
              ({
                id,
                ...
                <SwiperSlide
                  key={id}
                  className="relative flex justify-start items-center animate-fadeIn"
                >
                  <div className="relative w-full h-full rounded-lg">
                    ...
                    <div className="flex flex-col justify-between h-full">
                      <div className="absolute left-8 bottom-6 z-5 max-w-[60%] md:left-4 nd:bottom-6">
